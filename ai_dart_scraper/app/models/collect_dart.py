...
class CollectDart(BaseCollections):
    ...
    company_id = Column(Integer, ForeignKey('new_company_info.id'), nullable=True, comment='companies.new_company_info.id')
    ...
    created_at = Column(Date, comment='생성 날짜')
    updated_at = Column(Date, comment='수정 날짜')
